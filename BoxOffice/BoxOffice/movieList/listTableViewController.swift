...
class listTableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataRequest(getURL: "https://connect-boxoffice.run.goorm.io/movies?order_type=2")
    ...
    func initRefresh() {
        refreshControl.addTarget(self, action: #selector(refreshTableView(refresh:)), for: .valueChanged)
    ...
    // 셀 내용
    var datasource: UITableViewDiffableDataSource<Int, movieListFormat>!

    func setDataSource() {
        datasource = UITableViewDiffableDataSource(tableView: self.tableView ?? UITableView(),
